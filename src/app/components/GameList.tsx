...
export default function GameList() {
    ...
    if (isLoading) return <div className="m-24 text-center text-4xl">Loading...</div>;
    if (error || !data)
        return (
    ...
    return (
        <div>
            <div className={"inline-grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-28 gap-y-12"}>
                {data.map((page: any) =>
