...
export default function HomeHeader() {
  return(
    <div className="m-6 flex justify-between text-brown-darker gap-4">
      <div className="flex gap-4 items-center">
        <Link href="/">
          <Image src="/logo.png" width={60} height={69} alt="logo" />
        </Link>
        <h1 className="text-lg md:text-3xl">DTA32&apos;s Flash Game Sites</h1>
      </div>
      <div className="hidden md:flex gap-6 items-center">
        <div className="flex rounded-lg border border-brown-dark p-3 max-h-12 gap-2">
          <input type="text" className="text-brown-darker bg-cream-light w-full max-w-[196px]" placeholder="Search games"/>
          <button type="submit">
